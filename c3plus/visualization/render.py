...
from c3plus.configs.paths import REPO as CHECKOUT_ROOT

REPO = str(CHECKOUT_ROOT)
...
def _verify_recorded_model(path, result):
    ...
    if path.suffix.lower() == ".sdf":
        from c3plus.configs.paths import model_assets
...
def build(object_sdf, obstacle_sdf, goal, assets_tmp):
    from pydrake.geometry import (ClippingRange, DepthRange, DepthRenderCamera,
