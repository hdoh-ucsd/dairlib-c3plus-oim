...
bazel-bin/examples/sampling_c3/franka_sim \
  --demo_name=matched_shelf_gap_xarm6_t4 --robot_model=xarm6 --matched_mu=true
bazel-bin/examples/sampling_c3/franka_osc_controller \
  --demo_name=matched_shelf_gap_xarm6_t4 --robot_model=xarm6 \
