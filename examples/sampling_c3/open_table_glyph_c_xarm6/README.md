...
## Run (sim trio, xArm6)
    ...
    bazel-bin/examples/sampling_c3/franka_sim --demo_name=open_table_glyph_c_xarm6 --robot_model=xarm6 --matched_mu=true
    bazel-bin/examples/sampling_c3/franka_osc_controller --demo_name=open_table_glyph_c_xarm6 --robot_model=xarm6 --xarm6_five_joint=true --prelift_release=true
    bazel-bin/examples/sampling_c3/franka_sampling_c3_controller --demo_name=open_table_glyph_c_xarm6 --robot_model=xarm6
